...
$filtered = array_filter($konsentrasi_data['konsentrasi'], fn($x) => $x['id'] == 'sistem-informasi');

// Cek apakah data ditemukan
if (empty($filtered)) {
    die("Error: Data dengan ID 'sistem-informasi' tidak ditemukan di dalam JSON.");
}
...
<body class="bg-slate-900 text-white">
    ...
    <!-- Hero Section -->
    <section class="pt-32 pb-20 bg-gradient-to-br from-indigo-900 via-slate-900 to-slate-900 relative overflow-hidden">
        <div class="absolute inset-0 opacity-10">
            <div class="absolute top-20 left-20 w-96 h-96 bg-indigo-500 rounded-full blur-3xl"></div>
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <p class="text-2xl text-indigo-300 mb-6"><?= $k['nama_inggris'] ?></p>
    ...
    <section class="py-20 bg-slate-800">
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-4 gap-4 max-w-5xl mx-auto">
                ...
                <div class="bg-slate-900 rounded-lg p-4 hover:bg-indigo-900/30 transition text-center">
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
                ...
                <div class="bg-slate-800 rounded-xl p-6 hover:scale-105 transition">
                    <h3 class="text-xl font-bold mb-3 text-indigo-400"><?= $career['title'] ?></h3>
                    <div class="mb-4">
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="bg-slate-900 rounded-xl p-8">
                    <div class="flex items-start gap-6">
                        <div class="w-20 h-20 bg-gradient-to-br from-indigo-600 to-cyan-600 rounded-full flex items-center justify-center text-3xl flex-shrink-0">
                            👤
                        </div>
                        <div class="flex-1">
                            <h3 class="text-2xl font-bold mb-2"><?= $alumni['nama'] ?></h3>
                            <p class="text-indigo-400 font-semibold mb-1"><?= $alumni['posisi'] ?></p>
                            <p class="text-slate-400 mb-4"><?= $alumni['perusahaan'] ?> • Angkatan <?= $alumni['angkatan'] ?></p>
                            <blockquote class="border-l-4 border-indigo-500 pl-4 italic text-slate-300">
                                "<?= $alumni['testimony'] ?>"
                            </blockquote>
                        </div>
                    </div>
    ...
    <section class="py-20 bg-slate-900">
        <div class="container mx-auto px-4">
            <h2 class="text-4xl font-bold text-center mb-12">🎯 Skills yang Dikuasai</h2>
            <div class="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                <div class="bg-slate-800 rounded-xl p-6">
                    <h3 class="text-xl font-bold mb-4 text-indigo-400">Technical Skills</h3>
                ...
                <div class="bg-slate-800 rounded-xl p-6">
                    <h3 class="text-xl font-bold mb-4 text-cyan-400">Business Skills</h3>
                    <ul class="space-y-2 text-sm">
                ...
                <div class="bg-slate-800 rounded-xl p-6">
                    <h3 class="text-xl font-bold mb-4 text-pink-400">Soft Skills</h3>
                    <ul class="space-y-2 text-sm">
    ...
    <section class="py-20 bg-gradient-to-r from-indigo-600 to-cyan-600">
        <div class="container mx-auto px-4 text-center">
            <h2 class="text-4xl font-bold mb-6">Tertarik dengan Sistem Informasi?</h2>
            <p class="text-xl mb-8">Jadilah Business Analyst atau System Analyst profesional</p>
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="../kontak.php" class="px-8 py-4 bg-white text-indigo-600 rounded-lg font-semibold hover:bg-slate-100 transition">
                    Hubungi Kami
                </a>
                <a href="index.php" class="px-8 py-4 bg-transparent border-2 border-white rounded-lg font-semibold hover:bg-white hover:text-indigo-600 transition">
